...
/**
 * <p>Title: com.sgu.objs.ObjLicenciatura</p>
 * <p>Description: Objeto para almacenar los datos de una licenciatura.</p>
 * @author Gorka Suárez García
 * @version 1.0
 */
public class ObjLicenciatura
{
    //-----------------------------------------------------------------------
    ...
    /**
     * Constructor de la clase.
     * @param id          ID de la licenciatura.
     * @param universidad ID de la universidad de la licenciatura.
     * @param facultad    ID de la facultad de la licenciatura.
     * @param nombre      Nombre de la licenciatura.
     */
    public ObjLicenciatura (int id, int universidad, int facultad, String nombre)
    {
        this.id = id;
     ...
     */
    public ObjLicenciatura (ObjLicenciatura obj)
    {
        this.id = obj.id;
