...
/**
 * <p>Title: com.sgu.objs.ObjAdministrador</p>
 * <p>Description: Objeto para almacenar los datos de un administrador.</p>
 * @author Gorka Suárez García
 * @version 1.0
 */
public class ObjAdministrativo
{
    //-----------------------------------------------------------------------
     ...
     * @param universidad ID de la universidad del administrativo.
     * @param facultad    ID de la facultad del administrativo.
     * @param nombre      Nombre del administrativo.
     * @param apellidos   Apellidos del administrativo.
     */
    public ObjAdministrativo (int dni, int universidad, int facultad,
     ...
     */
    public ObjAdministrativo (ObjAdministrativo obj)
    {
        this.dni = obj.dni;
